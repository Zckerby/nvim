--==================================================================================================
-- THEMES  (themery.nvim theme switcher + colorscheme plugins)
--==================================================================================================
...
vim.pack.add({
	...
	{ src = "https://github.com/navarasu/onedark.nvim", version = "v0.1.0" },
...
require("themery").setup({
	themes = {
		...
		{ name = "houston", colorscheme = "houston" },
		{ name = "purplePink", colorscheme = "shado" },
	},
	livePreview = true,
})
